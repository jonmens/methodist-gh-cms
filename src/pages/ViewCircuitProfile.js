        ...
        <div className="content-wrapper">
            ...
            <section className="content-header">
                <div className="container-fluid">
                    <Link to="/addnewcircuit">
                    <button type="button" className="btn btn-primary btn-flat">Add New Circuit</button>
                    </Link>
                    <br/>
                    <br/>
...
export default ViewCircuitProfile
